...
export default function HeroVisual() {
  return (
    <div className="relative h-[380px] stitch-node-glass rounded-xl overflow-hidden border border-white/5 bg-surface-container-low flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center relative">
        <div className="flex flex-col items-center gap-2">
          <pre
            className="text-pink-neon/60 leading-relaxed text-center select-none text-[8px]"
